...
namespace Aylien.NewsApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Autocompletes :  IEquatable<Autocompletes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Autocompletes" /> class.
        /// </summary>
        /// <param name="_Autocompletes">An array of autocompletes.</param>
        public Autocompletes(List<Autocomplete> _Autocompletes = default(List<Autocomplete>))
        {
