...
namespace Aylien.NewsApi.Api
{
    ...
    public interface IDefaultApi
    {
        ...
        /// <param name="term">This parameter is used for finding autocomplete objects whose contains the specified value.</param>
        ...
        /// <param name="perPage">This parameter is used for specifying number of the items in each page. (optional, default to 3)</param>
        ...
        /// <param name="publishedAtStart">This parameter is used for finding stories whose published at is greater than the specified value. [Here](https://newsapi.aylien.com/docs/working-with-dates) you can find more information about how [to work with dates](https://newsapi.aylien.com/docs/working-with-dates). (optional)</param>
        /// <param name="publishedAtEnd">This parameter is used for finding stories whose published at is less than the specified value. [Here](https://newsapi.aylien.com/docs/working-with-dates) you can find more information about how [to work with dates](https://newsapi.aylien.com/docs/working-with-dates). (optional)</param>
        /// <param name="categoriesTaxonomy">This parameter is used for defining type of the taxonomy for the rest of categories queries. (optional)</param>
        ...
        /// <param name="categoriesId">This parameter is used for finding stories whose categories id is the specified value. (optional)</param>
        /// <param name="categoriesLevel">This parameter is used for finding stories whose categories level is the specified value. (optional)</param>
        /// <param name="entitiesTitleText">This parameter is used for finding stories whose entities text in title is the specified value. (optional)</param>
        /// <param name="entitiesTitleType">This parameter is used for finding stories whose entities type in title is the specified value. (optional)</param>
        /// <param name="entitiesTitleLinksDbpedia">This parameter is used for finding stories whose entities dbpedia url in title is the specified value. (optional)</param>
        /// <param name="entitiesBodyText">This parameter is used for finding stories whose entities text in body is the specified value. (optional)</param>
        /// <param name="entitiesBodyType">This parameter is used for finding stories whose entities type in body is the specified value. (optional)</param>
        /// <param name="entitiesBodyLinksDbpedia">This parameter is used for finding stories whose entities dbpedia url in body is the specified value. (optional)</param>
        ...
        /// <param name="sourceLocationsCountry">This parameter is used for finding stories whose source country is the specified value. It supports [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country codes. (optional)</param>
        /// <param name="sourceLocationsState">This parameter is used for finding stories whose source state/province is the specified value. (optional)</param>
        /// <param name="sourceLocationsCity">This parameter is used for finding stories whose source city is the specified value. (optional)</param>
        /// <param name="sourceScopesCountry">This parameter is used for finding stories whose source scopes country is the specified value. It supports [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country codes. (optional)</param>
        /// <param name="sourceScopesState">This parameter is used for finding stories whose source scopes state/province is the specified value. (optional)</param>
        /// <param name="sourceScopesCity">This parameter is used for finding stories whose source scopes city is the specified value. (optional)</param>
        /// <param name="sourceScopesLevel">This parameter is used for finding stories whose source scopes level is the specified value. (optional)</param>
        ...
        /// <param name="storyPublishedAt">Publish date of the article. If you use url or title and body for getting coverages, this parameter is required. The format used is a restricted form of the canonical representation of dateTime in the [XML Schema specification (ISO 8601)](https://www.w3.org/TR/xmlschema-2/#dateTime). (optional)</param>
        /// <param name="storyLanguage">This parameter is used for setting language of the story. It supports [ISO 639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language codes. (optional, default to auto)</param>
        /// <param name="perPage">This parameter is used for specifying number of the items in each page. (optional, default to 3)</param>
        ...
        /// <param name="storyTitle">Title of the article (optional)</param>
        /// <param name="storyBody">Body of the article (optional)</param>
        /// <param name="boostBy">This parameter is used for boosting result by the specified value. (optional)</param>
        /// <param name="storyLanguage">This parameter is used for setting language of the story. It supports [ISO 639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language codes. (optional, default to auto)</param>
        /// <param name="perPage">This parameter is used for specifying number of the items in each page. (optional, default to 3)</param>
        ...
        /// <param name="clusterAlgorithm">This parameter is used for specifying the clustering algorithm. It supprts STC, Lingo and [k-means](https://en.wikipedia.org/wiki/K-means_clustering) algorithms. (optional, default to lingo)</param>
        /// <param name="_return">This parameter is used for specifying return fields. (optional)</param>
        /// <param name="sortBy">This parameter is used for changing the order column of the result. (optional, default to published_at)</param>
        ...
        /// <param name="perPage">This parameter is used for specifying number of the items in each page. (optional, default to 10)</param>
        ...
        /// <param name="sourceScopesCity">This parameter is used for finding stories whose source scopes city is the specified value. (optional)</param>
        /// <param name="sourceScopesLevel">This parameter is used for finding stories whose source scopes level is the specified value. (optional)</param>
        /// <param name="publishedAtStart">This parameter is used for finding stories whose published at is less than the specified value. [Here](https://newsapi.aylien.com/docs/working-with-dates) you can find more information about how [to work with dates](https://newsapi.aylien.com/docs/working-with-dates). (optional, default to NOW-7DAYS/DAY)</param>
        /// <param name="publishedAtEnd">This parameter is used for finding stories whose published at is greater than the specified value. [Here](https://newsapi.aylien.com/docs/working-with-dates) you can find more information about how [to work with dates](https://newsapi.aylien.com/docs/working-with-dates). (optional, default to NOW/DAY)</param>
        /// <param name="period">The size of each date range expressed as an interval to be added to the lower bound. It supports Date Math Syntax. Valid options are &#x60;+&#x60; following an integer number greater than 0 and one of the Date Math keywords. e.g. &#x60;+1DAY&#x60;, &#x60;+2MINUTES&#x60; and &#x60;+1MONTH&#x60;. Here are [Supported keywords](https://newsapi.aylien.com/docs/working-with-dates#date-math). (optional, default to +1DAY)</param>
    ...
    public class DefaultApi : IDefaultApi
    {
        ...
        /// <summary>
        /// List coverages This endpoint is used for finding story coverages based on provided parameters. The number of coverages to return, up to a maximum of 100.
        /// </summary>
        /// <exception cref="Aylien.NewsApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">This parameter is used for finding stroies by story id. (optional)</param>
        /// <param name="title">This parameter is used for finding stories whose title contains a specfic keyword. It supports [boolean operators](https://newsapi.aylien.com/docs/boolean-operators). (optional)</param>
        ...
        /// <summary>
        /// List histograms This endpoint is used for getting histograms based on the field parameter is passed.
        /// </summary>
        /// <exception cref="Aylien.NewsApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">This parameter is used for finding stroies by story id. (optional)</param>
        /// <param name="title">This parameter is used for finding stories whose title contains a specfic keyword. It supports [boolean operators](https://newsapi.aylien.com/docs/boolean-operators). (optional)</param>
        ...
        public ApiResponse<Histograms> ListHistogramsWithHttpInfo(List<long?> id = null, string title = null, string body = null, string text = null, List<string> language = null, string publishedAtStart = null, string publishedAtEnd = null, string categoriesTaxonomy = null, bool? categoriesConfident = null, List<string> categoriesId = null, List<int?> categoriesLevel = null, List<string> entitiesTitleText = null, List<string> entitiesTitleType = null, List<string> entitiesTitleLinksDbpedia = null, List<string> entitiesBodyText = null, List<string> entitiesBodyType = null, List<string> entitiesBodyLinksDbpedia = null, string sentimentTitlePolarity = null, string sentimentBodyPolarity = null, List<int?> authorId = null, string authorName = null, List<int?> sourceId = null, List<string> sourceName = null, List<string> sourceDomain = null, List<string> sourceLocationsCountry = null, List<string> sourceLocationsState = null, List<string> sourceLocationsCity = null, List<string> sourceScopesCountry = null, List<string> sourceScopesState = null, List<string> sourceScopesCity = null, List<string> sourceScopesLevel = null, int? intervalStart = null, int? intervalEnd = null, int? intervalWidth = null, string field = null)
        {
            ...
            if (id != null)
                foreach (var val in id)
                    localVarFormParams.Add(new Tuple<String, String>("id[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (title != null) localVarFormParams.Add(new Tuple<String, String>("title", Configuration.ApiClient.ParameterToString(title))); // query parameter
            if (body != null) localVarFormParams.Add(new Tuple<String, String>("body", Configuration.ApiClient.ParameterToString(body))); // query parameter
            if (text != null) localVarFormParams.Add(new Tuple<String, String>("text", Configuration.ApiClient.ParameterToString(text))); // query parameter
            if (language != null)
                foreach (var val in language)
                    localVarFormParams.Add(new Tuple<String, String>("language[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (publishedAtStart != null) localVarFormParams.Add(new Tuple<String, String>("published_at.start", Configuration.ApiClient.ParameterToString(publishedAtStart))); // query parameter
            if (publishedAtEnd != null) localVarFormParams.Add(new Tuple<String, String>("published_at.end", Configuration.ApiClient.ParameterToString(publishedAtEnd))); // query parameter
            if (categoriesTaxonomy != null) localVarFormParams.Add(new Tuple<String, String>("categories.taxonomy", Configuration.ApiClient.ParameterToString(categoriesTaxonomy))); // query parameter
            if (categoriesConfident != null) localVarFormParams.Add(new Tuple<String, String>("categories.confident", Configuration.ApiClient.ParameterToString(categoriesConfident))); // query parameter
            if (categoriesId != null)
                foreach (var val in categoriesId)
                    localVarFormParams.Add(new Tuple<String, String>("categories.id[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (categoriesLevel != null)
                foreach (var val in categoriesLevel)
                    localVarFormParams.Add(new Tuple<String, String>("categories.level[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (entitiesTitleText != null)
                foreach (var val in entitiesTitleText)
                    localVarFormParams.Add(new Tuple<String, String>("entities.title.text[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (entitiesTitleType != null)
                foreach (var val in entitiesTitleType)
                    localVarFormParams.Add(new Tuple<String, String>("entities.title.type[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (entitiesTitleLinksDbpedia != null)
                foreach (var val in entitiesTitleLinksDbpedia)
                    localVarFormParams.Add(new Tuple<String, String>("entities.title.links.dbpedia[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (entitiesBodyText != null)
                foreach (var val in entitiesBodyText)
                    localVarFormParams.Add(new Tuple<String, String>("entities.body.text[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (entitiesBodyType != null)
                foreach (var val in entitiesBodyType)
                    localVarFormParams.Add(new Tuple<String, String>("entities.body.type[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (entitiesBodyLinksDbpedia != null)
                foreach (var val in entitiesBodyLinksDbpedia)
                    localVarFormParams.Add(new Tuple<String, String>("entities.body.links.dbpedia[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (sentimentTitlePolarity != null) localVarFormParams.Add(new Tuple<String, String>("sentiment.title.polarity", Configuration.ApiClient.ParameterToString(sentimentTitlePolarity))); // query parameter
            if (sentimentBodyPolarity != null) localVarFormParams.Add(new Tuple<String, String>("sentiment.body.polarity", Configuration.ApiClient.ParameterToString(sentimentBodyPolarity))); // query parameter
            if (authorId != null)
                foreach (var val in authorId)
                    localVarFormParams.Add(new Tuple<String, String>("author.id[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (authorName != null) localVarFormParams.Add(new Tuple<String, String>("author.name", Configuration.ApiClient.ParameterToString(authorName))); // query parameter
            if (sourceId != null)
                foreach (var val in sourceId)
                    localVarFormParams.Add(new Tuple<String, String>("source.id[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (sourceName != null)
                foreach (var val in sourceName)
                    localVarFormParams.Add(new Tuple<String, String>("source.name[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (sourceDomain != null)
                foreach (var val in sourceDomain)
                    localVarFormParams.Add(new Tuple<String, String>("source.domain[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (sourceLocationsCountry != null)
                foreach (var val in sourceLocationsCountry)
                    localVarFormParams.Add(new Tuple<String, String>("source.locations.country[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (sourceLocationsState != null)
                foreach (var val in sourceLocationsState)
                    localVarFormParams.Add(new Tuple<String, String>("source.locations.state[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (sourceLocationsCity != null)
                foreach (var val in sourceLocationsCity)
                    localVarFormParams.Add(new Tuple<String, String>("source.locations.city[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (sourceScopesCountry != null)
                foreach (var val in sourceScopesCountry)
                    localVarFormParams.Add(new Tuple<String, String>("source.scopes.country[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (sourceScopesState != null)
                foreach (var val in sourceScopesState)
                    localVarFormParams.Add(new Tuple<String, String>("source.scopes.state[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (sourceScopesCity != null)
                foreach (var val in sourceScopesCity)
                    localVarFormParams.Add(new Tuple<String, String>("source.scopes.city[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
            if (sourceScopesLevel != null)
                foreach (var val in sourceScopesLevel)
                    localVarFormParams.Add(new Tuple<String, String>("source.scopes.level[]", Configuration.ApiClient.ParameterToString(val))); // query parameter
        ...
        /// <summary>
        /// List related stories This endpoint is used for finding related stories based on provided parameters. The number of related stories to return, up to a maximum of 100.
        /// </summary>
        /// <exception cref="Aylien.NewsApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">This parameter is used for finding stroies by story id. (optional)</param>
        /// <param name="title">This parameter is used for finding stories whose title contains a specfic keyword. It supports [boolean operators](https://newsapi.aylien.com/docs/boolean-operators). (optional)</param>
        ...
        /// <summary>
        /// List Stories This endpoint is used for getting list of stories.
        /// </summary>
        /// <exception cref="Aylien.NewsApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">This parameter is used for finding stroies by story id. (optional)</param>
        /// <param name="title">This parameter is used for finding stories whose title contains a specfic keyword. It supports [boolean operators](https://newsapi.aylien.com/docs/boolean-operators). (optional)</param>
        ...
        /// <summary>
        /// List trends This endpoint is used for finding news trendings based on stories resource.
        /// </summary>
        /// <exception cref="Aylien.NewsApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">This parameter is used for finding stroies by story id. (optional)</param>
        /// <param name="title">This parameter is used for finding stories whose title contains a specfic keyword. It supports [boolean operators](https://newsapi.aylien.com/docs/boolean-operators). (optional)</param>
