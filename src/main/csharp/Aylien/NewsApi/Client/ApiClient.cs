...
namespace Aylien.NewsApi.Client
{
    ...
    public class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://api.newsapi.aylien.com/api/v1");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.newsapi.aylien.com/api/v1).
        /// </summary>
        ...
        private RestRequest PrepareRequest(
            ...
            Dictionary<String, String> headerParams, List<Tuple<String, String>> formParams,
