...
namespace Aylien.NewsApi.Model
{
    ...
    { 
        ...
        /// </summary>
        /// <value>The level of the scope</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum LevelEnum {
            
			///<Summary>
			/// Interncational level
			///</Summary>
        ...
        /// Initializes a new instance of the <see cref="Scope" />class.
        /// </summary>
        /// <param name="Country">The country code of the scope. It supports [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country codes..</param>
        /// <param name="State">The state of the scope.</param>
        /// <param name="City">The city of the scope.</param>
        /// <param name="Level">The level of the scope.</param>
        ...
        /// </summary>
        /// <value>The country code of the scope. It supports [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country codes.</value>
        ...
        /// </summary>
        /// <value>The state of the scope</value>
        ...
        /// </summary>
        /// <value>The city of the scope</value>
